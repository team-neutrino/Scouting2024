...
function alliancePick(alliance) {
  ...
  if(alliance == "Red Alliance") {
    document.getElementById('indexTable').style.backdropFilter = '-webkit-hue-rotate(170deg)';
    document.getElementById('indexTable').style.backdropFilter = 'hue-rotate(170deg)';
  }
  if(alliance == "Blue Alliance") {
    document.getElementById('indexTable').style.backdropFilter = '-webkit-hue-rotate(40deg)';
