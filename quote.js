...
"Sarah Y": ["I wish someone would quote meeeee!", "High School is fun except for the school part ", "Kanye didn't do anything wrong!", "We are a group. We rise together, we fall together. And I’m the only one falling right now!", ""],
"William M": ["Was wendsday your first time using drugs?", ""],
"Michael H": ["Thanks for talking about my body Matthias ", "Why do you keep trying to get me to go on a date with you [Adam]? He’s asked me on a date two times already! He’s staring longingly at me! ", "I got a victory royale, right kids? Poggers.", ""],
...
"Adam Z": ["Ewwwww do you have leprosy?", ""],
"Owen M": ["I know a bit about leadership, I'm the drop leader for my Fortnite squad.", "You're not an oxymoron, you're just a regular moron", "The day that Costco raises the price of rotisserie chicken is the day I will rebel against the government ", "(with a Southern accent) my pronouns are 39/28", ""],
...
"Elijah S": ["They should start flavoring tools", "I got pulled over and shot at by the police while wearing the neutrino logo!", "They should start flavoring tools", ""],
"Chetas A": ["Don't quote me on that!", "Accept my pull request or I will murder you!", ""],
"Laura W": ["You look like a tree!", ""],
"Lovie R": ["If caffeine counts as a drug. I give drugs to kids!", "If caffeine counts as a drug, I give drugs to kids!", ""],
"Anton L": ["There’s the big half inch and the small half inch", "I found multiple dead bunnies in my hose", "We do not like success here on Team Neutrino.", "Saudi Arabia is shaped like a rhinocerotops", "Matthias should become our mascot", "2306 is the opposite of empty ", "There’s the big half inch and the small half inch", ""],
...
"Logan M": ["I'd rather eat some bedazzled trash than normal trash y'know what I'm saying", "Bada bing bada boom hammer and sickle ", "Hotdog is the species, the sandwich is the genus", "I just love unloading shotgun shells into random people!", ""],
"Andrew G": ["Hey Dagney, we just dominated all these children. Good job :D", "Hey Dagney, we just dominated all these children. Good job :D", ""],
"Leslie K": ["Don't fear! We're not broke... I think", "Now I can touch Andrew’s keyboard with my grimy, greasy hands!", "I’m not feeling Gucci I’m more like Versace ", "Have you ever seen stupidity evolve? Darwinism is going the wrong way. ", "I dont want to look like I've committed a murder!", ""],
...
"Micah S": ["Tap Magic is the magic the Hole Wizard uses", "We don’t need no Becky round here (in a western accent)", "I’m gonna quit the team if we win spirit award", ""],
...
"Shreya S": ["Oh my god its only six!!!", ""],
...
"Joe Biden": ["Folks, I can tell you I've known eight presidents, three of them intimately.", ""],
